...
<html data-wf-page="5b5cbdb9e90d48c91fa266f3" data-wf-site="5ac4e2ea0012b09094785ef0">
<head>
  <meta charset="utf-8">
  <title>Buy Avengers</title>
  <meta content="Buy Avengers" property="og:title">
...
<body>
  ...
  <div class="section">
    ...
    <div class="row w-row">
      <div class="w-col w-col-6"><a href="card-payment.jsp" class="link w-button">Debit Card</a></div>
      <div class="w-col w-col-6"><a href="account-avg.jsp" class="link-2 w-button">Bank Account</a></div>
        <div class="w-col w-col-6"><a href="qr" class="link w-button">QR Pay</a></div>
    </div>
  </div>
