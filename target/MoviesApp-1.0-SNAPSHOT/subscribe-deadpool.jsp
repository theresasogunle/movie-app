...
<html data-wf-page="5b5cbe8489ff9c6185242a93" data-wf-site="5ac4e2ea0012b09094785ef0">
<head>
  <meta charset="utf-8">
  <title>Subcribe Deadpool</title>
  <meta content="Subcribe Deadpool" property="og:title">
...
<body>
  ...
  <div class="section">
    <div class="text-block-3">Subscribe to Deadpool</div>
    <div class="text-block-2">Price - N300 monthly</div>
    <h1 class="heading">Subscribe</h1>
    <div class="row w-row">
      <div class="w-col w-col-6"><a href="card-payment-dp.jsp" class="link w-button">Debit Card</a></div>
      <div class="w-col w-col-6"><a href="account-dp.jsp" class="link-2 w-button">Bank Account</a></div>
    </div>
  </div>
