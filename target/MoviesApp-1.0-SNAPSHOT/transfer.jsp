...
<html data-wf-page="5b5cd14ac3f7cb33de47f678" data-wf-site="5ac4e2ea0012b09094785ef0">
    ...
    <body>
        ...
        <div class="w-container">
            <div class="w-form">
                <form id="email-form" name="email-form" action="transfer" method="POST" data-name="Email Form" class="form"><label for="banks">Bank:</label><select id="banks" name="bank" required="" data-name="banks" class="w-select"> 
