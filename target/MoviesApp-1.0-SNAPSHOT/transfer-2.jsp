...
<body>
  ...
  <div class="section">
    <div class="text-block-2">Transfer - Step 2</div>
  </div>
  <div class="w-container">
    <div class="w-form">
      <form method="POST" name="email-form" action="transfer-2"  data-name="Email Form" class="form"><label for="amount">Amount:</label><input type="text" class="text-field-2 w-input" maxlength="256" name="amount" data-name="naration" placeholder="500" id="naration"><label for="naration">Narration:</label><input type="text" class="text-field-2 w-input" maxlength="256" name="narration" data-name="naration" placeholder="Pocket Money" id="naration"><input type="submit" value="Transfer" data-wait="Please wait..." class="w-button"></form>
